 ...
 */
exportable.clone = function clone(instance) {
    let p1, p2
 ...
 * @param {Response|Request} instance Response or Request instance
 */
exportable.extractContentType = function extractContentType(instance) {
    const {
        body
    } = instance
...
exportable.getTotalBytes = function getTotalBytes(instance) {
    const {
        body
    } = instance
...
exportable.writeToStream = function writeToStream(dest, instance) {
    const {
        body
    } = instance
